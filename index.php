	...
	<div class="bg-gray-50 min-h-screen hidden md:block">
		<div class="grid grid-cols-6">
			...
			<div class="flex justify-between items-center mb-4">
				<h2 class="text-gray-400 font-semibold text-2xl mb-3">All Products</h2>
				...
				<div class="h-screen w-full fixed left-0 top-0 flex justify-center items-center hidden" id="<?php echo $row['id']; ?>" style="zIndex: 100">
